    ...
    function GameViewModel(game) {
        ...
        var currentSystemCardListConditionsRule = ko.computed(function() {
            ...
            var list = _.map(self.currentSystemCardList(), function (element) {
                ...
                // console.log("is com card:");
                // console.log(element.isComCard());
        ...
        // Maybe warning for specific card type being full
        self.showDataBankComFullWarning = ko.observable(false);
        var showDataBankComFullWarningRule = ko.computed(function () {
